...
namespace AssetManager {
    ...
    private:
        ...
        static std::unique_ptr<Renderer::Shader>
        makeShader(const std::string &vertex_path, const std::string &fragment_path, const std::string &geometry_path);
