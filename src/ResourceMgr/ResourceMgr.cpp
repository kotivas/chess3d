...
namespace ResourceMgr {
    ...
    uint32_t CreateTexture3D(
        const std::string &path, uint16_t h, uint16_t w, uint16_t d, const Renderer::TextureWrapMode wrap_mode) {
        ...
        glTexImage3D(GL_TEXTURE_3D, 0, GL_R32F, w, h, d, 0, GL_RED, GL_FLOAT, noiseData.data());
