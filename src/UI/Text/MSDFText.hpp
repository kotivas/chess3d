...
namespace MsdfText {
    ...
    int GetMaxCharactersForWidth(const std::string &text, const FontPtr &font, float scale, float max_width);
    int GetMaxCharactersForWidth(const Text &text, float max_width);
